angular.module("Ikaruga-like")
    .controller('GameplayCtrl', function(){
        ...
        function preload() {
          ...
          game.load.spritesheet('right', 'spaceArt/png/playerRight.png');
          game.load.spritesheet('left', 'spaceArt/png/playerLeft.png');
        ...
        function update() {
            ...
            else if (cursors.right.isUp)
            {
                ...
                plaer.body.velocity.x = 0;
            }
            else if (cursors.up.isUp)
            {

                plaer.body.velocity.y = 0;
            }
            ...
            starField.tilePosition.y += 2;
                ...
                //Collision
            game.physics.arcade.overlap(bullet, aliens, collisionHandler, null, this);
            game.physics.arcade.overlap(enemyBullet, player, enemyHitsPlayer, null, this);
            ...
            // //     //  Grab the first bullet we can from the pool
                 ...
                 aliens.forEachAlive(function(aliens){
            ...
            function restart () {
                ...
                //  And brings the alienss back from the dead :)
                aliens.removeAll();
                createAliens();
